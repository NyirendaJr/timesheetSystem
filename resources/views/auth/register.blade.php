                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                          ...
                          <div class="form-group row">
                              <label for="regNo" class="col-md-4 col-form-label text-md-right">{{ __('Reg Number') }}</label>
                          ...
                          <!-- <div class="form-group row">
                              <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
